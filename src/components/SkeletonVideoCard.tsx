...
export default function SkeletonVideoCard({
  ...
  if (layout === undefined || layout === "col") {
    return (
      ...
      >
        <figure className="aspect-video rounded w-full bg-zinc-500 dark:bg-black animate-pulse"></figure>
    ...
    return (
      ...
      >
        <figure className="aspect-square rounded w-2/5 md:w-1/3 bg-zinc-500 dark:bg-black"></figure>
        <div className="w-3/5 md:w-2/3 h-full flex flex-col justify-start gap-2 bg-gray-100 dark:bg-zinc-800 px-3 py-4">
