...
const RelatedVideosList = ({
  ...
  const dummyVideos = new Array(15).fill(1);

  if (isFetched && !isLoading) {
    return (
      <aside className="w-full lg:w-1/3 mt-12 lg:mt-0">
        <span className="w-full flex justify-center items-center gap-3 capitalize text-lg font-medium border-l-4 border-red-400 bg-zinc-200 px-2 py-1.5 mb-10">
          <h4>realated videos</h4>
          <i className="fi fi-sr-angle-small-down leading-3"></i>
        </span>
