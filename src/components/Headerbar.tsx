...
function Headerbar() {
  return (
    <header className="sticky top-0 w-full h-14 flex justify-between items-center bg-white border-b">
      <section className="yt-container flex justify-start items-center">
        <div className="flex items-center justify-start gap-6 w-3/4 md:w-3/12">
          <i className="fi fi-rr-menu-burger leading-3 text-2xl"></i>
          <Logo />
        </div>
        <form
          action=""
          className="w-2/5 flex items-center justify-start bg-slate-100 px-3"
        >
          <label
        ...
        <div className="w-1/4 flex justify-center items-center gap-2 ml-auto">
